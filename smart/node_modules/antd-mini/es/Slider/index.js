...
Component({
    ...
    didMount: function () {
        ...
        var sliderId = "amd-slider-id-".concat(this.$id);
        this.setData({
            sliderId: sliderId
        });
    ...
    didUpdate: function (prevProps) {
        if (!(0, fast_deep_equal_1.default)(this.props.value, prevProps.value)) {
            this.updateByProps(this.props.value, {
                isAfterChange: false,
                isSilentOnChange: true,
            });
        }
        else if (!(0, fast_deep_equal_1.default)(this.props.min, prevProps.min) ||
            ...
            !(0, fast_deep_equal_1.default)(this.props.ticks, prevProps.ticks)) {
    ...
    methods: {
        updateByProps: function (newValue, _a) {
            var _b = _a === void 0 ? {} : _a, _c = _b.isAfterChange, isAfterChange = _c === void 0 ? false : _c, _d = _b.isSilentOnChange, isSilentOnChange = _d === void 0 ? true : _d;
            var _e = this.props, min = _e.min, max = _e.max, step = _e.step, range = _e.range, ticks = _e.ticks;
        ...
        updateValue: function (value, step, _a) {
            if (step === void 0) { step = 1; }
            var _b = _a === void 0 ? {} : _a, _c = _b.isAfterChange, isAfterChange = _c === void 0 ? false : _c, _d = _b.isSilentOnChange, isSilentOnChange = _d === void 0 ? false : _d;
            var _e = this.props, onChange = _e.onChange, onAfterChange = _e.onAfterChange;
            ...
            if (!this.isSliderValueEqual(currentValue, prevValue) && typeof onChange === 'function' && !isSilentOnChange) {
                onChange(currentValue, (0, fmtEvent_1.default)(this.props));
            }
            if (isAfterChange && typeof onAfterChange === 'function') {
                onAfterChange(currentValue, (0, fmtEvent_1.default)(this.props));
            }
        },
        ...
        setTickList: function (step, min, max) {
            var tickList = [];
