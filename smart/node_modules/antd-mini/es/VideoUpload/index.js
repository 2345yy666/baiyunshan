...
Component({
    props: props_1.VideoUploadDefaultProps,
    data: {
        id: '',
        fileList: [],
        playVideoUrl: '',
    ...
    methods: {
        ...
        onChooseVideo: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, camera, maxDuration, sourceType, chooseVideoRes, size, tempFilePath, duration;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this.props, camera = _a.camera, maxDuration = _a.maxDuration, sourceType = _a.sourceType;
                            return [4 /*yield*/, (0, promisify_1.chooseVideo)({
                                    camera: camera,
                                    sourceType: sourceType,
                                    maxDuration: maxDuration,
                                })];
                        case 1:
                            chooseVideoRes = _b.sent();
                            if (chooseVideoRes) {
                                size = chooseVideoRes.size, tempFilePath = chooseVideoRes.tempFilePath, duration = chooseVideoRes.duration;
                                this.uploadFile({
                                    duration: duration,
                                    size: size,
        ...
        uploadFile: function (file) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, action, fileName, formData, onBeforeUpload, onUpload, onAfterUpload, fileList, tempFilePath, beforeUploadRes, tempFileList, res, response, resUrl, onUploadRes, e_1;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 13:
                            ...
                            this.updateFileList(tempFilePath, 'error');
                            my.showToast({
                                content: e_1.errorMessage || e_1.errorMsg || e_1.message || '上传失败，请重试',
                                type: 'fail',
                            });
                            return [3 /*break*/, 14];
        ...
        onPreviewVideo: function (e) {
            var _this = this;
            var previewVideoUrl = e.target.dataset.previewVideoUrl;
            this.setData({
